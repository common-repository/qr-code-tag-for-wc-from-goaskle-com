...
Tags: qr code, email, shortcode, woocommerce, custom template
...
QR Code for WooCommerce order emails, POS receipt emails, PDF invoices, PDF packing slips, Blog posts, Custom post types and Pages (from goaskle.com)

== Description ==

Full name of the plugin: <b>QR Code Tag for WC order emails, POS receipt emails, PDF invoices, PDF packing slips, Blog posts, Custom post types and Pages (from goaskle.com):</b>
...
* WooCommerce (All order emails) !!! ( Hash feature is temporarily supported until version 7.7.2, the issue with Woocommerce versions newer than 7.7.2 is related to the orders saving feature. So Just to go Woocommerce settings in Advanced tab and click on Features subtab. Then enable compatiblity mode for orders or select Legacy mode for orders. )
...
* Support Woocommerce Product Vendors ( blocked QR code in emails for vendors )
